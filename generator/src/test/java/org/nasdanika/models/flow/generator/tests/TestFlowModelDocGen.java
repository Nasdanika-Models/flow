 ...
 *
 */
public class TestFlowModelDocGen {
	...
	public void testGenerateFlowModelDoc() throws IOException, DiagnosticException {
		...
		EcoreGenFlowProcessorsFactory ecoreGenFlowProcessorFactory = new EcoreGenFlowProcessorsFactory(context);		
		...
		URI baseActionURI = URI.createURI("local://flow.models.nasdanika.org/");
				...
				if (element instanceof EObjectNode) {
					...
					if (target == topLevelPackage) {
						...
						if (processor instanceof WidgetFactory) {
							...
							if (topLevelPackage == FlowPackage.eINSTANCE) { 							
		...
		File output = new File(actionModelsDir, "flow.xmi");
		...
		String siteMapDomain = "https://flow.models.nasdanika.org";		
