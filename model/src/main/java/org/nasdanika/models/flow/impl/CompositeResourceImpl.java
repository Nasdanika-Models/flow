 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.flow.impl.CompositeResourceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeResourceImpl extends ResourceImpl implements CompositeResource {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.COMPOSITE_RESOURCE;
	}
	...
	public EList<Resource> getChildren() {
		return (EList<Resource>)eDynamicGet(FlowPackage.COMPOSITE_RESOURCE__CHILDREN, FlowPackage.Literals.COMPOSITE_RESOURCE__CHILDREN, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FlowPackage.COMPOSITE_RESOURCE__CHILDREN:
