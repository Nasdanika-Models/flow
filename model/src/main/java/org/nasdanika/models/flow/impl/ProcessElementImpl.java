 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.flow.impl.ProcessElementImpl#getRequirements <em>Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessElementImpl extends ModelElementImpl implements ProcessElement {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.PROCESS_ELEMENT;
	}
	...
	public EList<Requirement> getRequirements() {
		return (EList<Requirement>)eDynamicGet(FlowPackage.PROCESS_ELEMENT__REQUIREMENTS, CapabilityPackage.Literals.REQUIREMENT_CONSUMER__REQUIREMENTS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FlowPackage.PROCESS_ELEMENT__REQUIREMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RequirementConsumer.class) {
			switch (derivedFeatureID) {
				case FlowPackage.PROCESS_ELEMENT__REQUIREMENTS: return CapabilityPackage.REQUIREMENT_CONSUMER__REQUIREMENTS;
				default: return -1;
			}
		}
