 ...
 * @generated
 */
public class StartImpl extends FlowElementImpl implements Start {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public EList<ArtifactInfo> getOutputs() {
		return (EList<ArtifactInfo>)eDynamicGet(FlowPackage.START__OUTPUTS, FlowPackage.Literals.SOURCE__OUTPUTS, true, true);
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Source.class) {
			switch (derivedFeatureID) {
				...
				case FlowPackage.START__OUTPUTS: return FlowPackage.SOURCE__OUTPUTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Source.class) {
			switch (baseFeatureID) {
				...
				case FlowPackage.SOURCE__OUTPUTS: return FlowPackage.START__OUTPUTS;
				default: return -1;
			}
		}
